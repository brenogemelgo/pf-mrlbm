...
trajectory_label="${RTI_TRAJECTORY_LABEL:-RTI_TRAJECTORY_A05}"
trajectory_reynolds="${RTI_TRAJECTORY_REYNOLDS:-2048}"
trajectory_reynolds_tag="${RTI_TRAJECTORY_REYNOLDS_TAG:-RE2048}"
run_id="${trajectory_label}_${trajectory_reynolds_tag}"

rti_run_case CASE_TWO "${run_id}" "${trajectory_reynolds}" "${trajectory_weber}"
