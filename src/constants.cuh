...
constexpr real_t L_CHAR = static_cast<real_t>(NX);
...
constexpr real_t RTI_MASS_TOLERANCE_VALUE = ActiveCase::MASS_TOLERANCE;
...
constexpr real_t RTI_MASS_TOLERANCE_VALUE = static_cast<real_t>(0);
